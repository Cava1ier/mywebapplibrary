// Basic in-memory JavaScript library for CRUD operations on relational tables,
// supporting many-to-many via junction tables, with optional uniqueness constraints.
// Data can be loaded from a text format as described.
...
// Usage example:
// const drv = new DatabaseDriver(['Users', 'Groups', 'UserGroups']);
// drv.addUnique('Users', ['name']);
// const db = drv.getDatabase();
// db.create('Users', {name: 'John', email: 'john@example.com'});
// To define view for many-to-many: users and groups via userGroups
// db.views.addView('UserGroupsView', ['Users', 'UserGroups', 'Groups'], [
//   {leftTable: 'Users', leftCol: 'id', rightTable: 'UserGroups', rightCol: 'userId'},
//   {leftTable: 'UserGroups', leftCol: 'groupId', rightTable: 'Groups', rightCol: 'id'}
// ]);
// const viewData = db.views.getView('UserGroupsView').toArray();

// For loading from text:
// const text = `
// tblUsers:id|name|email
...
// User
//
// tblUserGroups:id|userId|groupId
// 1|1
// 1|2
// 2|2
// `;
// drv.loadFromText(text);
